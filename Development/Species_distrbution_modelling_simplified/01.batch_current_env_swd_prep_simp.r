...
cat("R CMD BATCH --no-save --no-restore '--args ' /home/jc246980/Freshwater_scripts/Final/Species_distribution_modelling_simplified/01.current_env_swd.r ",'Current.Rout \n',sep='',file=zz) #run the R script in the background
close(zz)
