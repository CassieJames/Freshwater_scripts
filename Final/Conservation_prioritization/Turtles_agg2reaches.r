...
species.data = read.csv("/home/jc246980/Species_data/Reach_data/Turtles_reach.csv") # read in species data
...
for(i in 2:ncol(species.data.final)) {
		...
		if(i==2){ Turtles.data=temp
	}else{Turtles.data=merge(Turtles.data, temp, by="SegmentNo", all.x=TRUE)
	}
	}
	
colnames(Turtles.data) = colnames(species.data.final)


out.dir="/home/jc246980/Zonation/"
save(Turtles.data,file=paste(out.dir,'Turtles_reach_aggregated.Rdata',sep=''))     # save