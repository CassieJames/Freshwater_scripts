...
wd = "/home/jc246980/Current projects/Northern Monsoonal/"; setwd(wd)                              # change wd for other inputs and  outputs

# Set up 250 m raster grid with reach identifier appended  and aggregate area by UID's

rivertasc = read.asc("Northsubcatch.asc")
...
colnames(Area_agg) =c('subcatch', 'UID','AREA')
          
save(Area_agg,file=paste(wd,'Area_aggregated_by_subcatch_5km.Rdata',sep=''))           # Save files out
