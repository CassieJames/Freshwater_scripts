...
cat("R CMD BATCH --no-save --no-restore '--args es=\"",es,"\" gcm=\"",gcm,"\" ' /home/jc246980/Freshwater_scripts/Final/Species_distribution_modelling/02.run_env_swd_prep.r ",es,'.',gcm,'.Rout \n',sep='',file=zz) #run the R script in the background
close(zz)
