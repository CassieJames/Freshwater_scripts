...
out=paste('/home/jc246980/SDM/Realized_current/',tax,'/Clipped2Basin/',sep='')
sh.dir='/home/jc246980/SDM/Realized_current/temp/'; setwd(sh.dir)
script.file = '/home/jc246980/Freshwater_scripts/Final/Species_distribution_modelling/05.script2run_fish_basins.r'
...
cat("R CMD BATCH --no-save --no-load '--args ",spp.arg,wd.arg,out.arg,es.arg,"' ",script.file,' 04.clip_distributions.Rout \n',sep='',file=zz)
close(zz)

#submit the job
system(paste('qsub -m n -N ',spp,' 04.clip_distributions.sh -l pmem=1000mb -l walltime=00:5:00 -l nodes=1:ppn=3 -l epilogue=/home/jc246980/epilogue/epilogue.sh',sep=''))
Sys.sleep(2)
