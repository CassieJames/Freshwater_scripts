...
occur.file=paste('/home/jc246980/Species_data/Reach_data/',taxname,"_ALL_reach_master.Rdata",sep='') #give the full file path of your species data
...
if (length(which(occur[,spp]>0)) > 0) { #model species where count is greater than 5
