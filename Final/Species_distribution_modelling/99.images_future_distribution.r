...
# C James February 2013
	...
	species.name=sub(".fut.real.mat.Rdata","", spp)	
	load(paste(wd,spp, sep='')) # Current		

	
	png(paste(image.dir,species.name,'_future_September 12.png',sep=''),width=dim(base.asc)[1]*3+300, height=dim(base.asc)[2]*4+150, units='px', pointsize=20, bg='WHITE')	
