...
yr=2085													# Select year (for projected future)
	...
	png(paste(es,'_richness_Figure1.1_',yr,'.png',sep=''),width=dim(base.asc)[1]*3+300, height=dim(base.asc)[2]*4+150, units='px', pointsize=20, bg='WHITE')	
...
for (tax in taxa) {print(tax)
	...
	load(paste('/home/jc246980/SDM/Richness/',es,"_",tax,'_Richness_quants.Rdata',sep='')) # Future
	pos=tpos
