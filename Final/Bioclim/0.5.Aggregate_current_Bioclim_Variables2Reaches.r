################################################################################
# Script to ggregate bioclim variables generated at 5km resolution onto Janets reaches for current (1976-2005) and (1960-1990) 
...
out.dir="/home/jc246980/Climate/5km/Baseline_1976_2005/Bioclim_reach/"
out.dir.1960="/home/jc246980/Climate/5km/Baseline_1960_1990/Bioclim_reach/"
...
colnames(Current.bioclim) = c('SegmentNo', paste(tt[,1],"_",tt[,2],sep='') )
...
colnames(Current.bioclim) = c('SegmentNo', paste(tt[,1],"_",tt[,2],sep='') )
write.csv(Current.bioclim,paste(out.dir.1960,"Current_bioclim_agg2reach.csv",sep=''),row.names=F)			
